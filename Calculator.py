...
buttonEqual = Button(root, text="=", padx=134, pady=20, command=button_equal)
buttonClear = Button(root, text="Clear", padx=125, pady=20, command=button_clear)
